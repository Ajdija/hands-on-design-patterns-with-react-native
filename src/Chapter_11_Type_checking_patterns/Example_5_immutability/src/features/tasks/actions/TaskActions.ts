...
const fetchTasksComplete = (tasks: ReadonlyArray<TaskType>):TasksFetchCompleteActionType => ({
    tasks,
...
const ActionTriggers = {
    ...
    fetchTasksComplete: (dispatch: Dispatch<any>) =>
        (tasks: ReadonlyArray<TaskType>) => dispatch(ActionCreators.fetchTasksComplete(tasks)),
